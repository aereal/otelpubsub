...
// InvalidAttributeTypeError indicates an [AttributeType] value is out of the valid range.
...
// UnknownAttributeTypeError indicates an unrecognized attribute type string was encountered during JSON unmarshaling.
